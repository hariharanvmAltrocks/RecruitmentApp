...
const PendingIcon: React.FC<{ color: string }> = ({ color }) => (
  <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke={color} strokeWidth="1.7" strokeLinecap="round">
...
const INFO_ICON = (
  <svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="#7C8BAA" strokeWidth="1.5" strokeLinecap="round">
    ...
    <div className={styles.root} ref={panelRef}>
      ...
      >
        ...
        <div className={styles.ringWrap}>
          <svg className={styles.ringSvg} viewBox="0 0 44 44">
            ...
            <circle
              ...
              cx="22" cy="22" r="18"
              style={{ strokeDashoffset: animated ? ringOffset : CIRCUMFERENCE }}
            />
          </svg>
        ...
        <div className={styles.triggerText}>
          ...
          <span className={styles.triggerSub}>{doneCount} of {total} complete</span>
        </div>
      ...
      {/* ── Drop-down panel ── */}
      <div className={`${styles.panel} ${open ? styles.panelOpen : ""}`} role="dialog" aria-label="Verification checklist">

        <div className={styles.panelHeader}>
          <span className={styles.panelTitle}>Verification checklist</span>
          <span className={styles.panelCountPill}>{doneCount} / {total} done</span>
        </div>
          ...
          {steps.map((step, idx) => (
            <React.Fragment key={step.id}>
              ...
              <div className={styles.stepItem}>
                ...
                <span className={`${styles.stepBadge} ${styles[`badge_${step.state}`]}`}>
