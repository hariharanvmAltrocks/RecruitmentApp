...
import { TrackerRow, PriorityData, UrgentTask, JobAdvertDetail, EvaluationRow, Candidate } from '../../models';
...
export const TRACKER_DATA: TrackerRow[] = [
...
export const PRIORITY_DATA: PriorityData[] = [
...
export const ADVERT_REVIEW_DATA: JobAdvertDetail[] = [
  {
    jobCode: 'SEN-100',
...
export const EVALUATION_DATA: EvaluationRow[] = [
...
export const CANDIDATE_SELECTION_DATA: Candidate[] = [
  {
