              ...
              return (
                ...
                >
                  <div className="iq-bank__card-top">
                    ...
                    <button
                      className={`iq-bank__add-btn ${isAdded ? "iq-bank__add-btn--added" : ""}`}
                  ...
                  <div className="iq-bank__card-body">
                    <div className="iq-bank__lang-row">
                      <span className="iq-bank__lang-pill iq-bank__lang-pill--en">EN</span>
                      <p className="iq-bank__question-text">{q.questionEn}</p>
                    </div>
                    <div className="iq-bank__lang-row">
                      <span className="iq-bank__lang-pill iq-bank__lang-pill--fr">FR</span>
                      <p className="iq-bank__question-text iq-bank__question-text--italic">{q.questionFr}</p>
                    </div>
                  </div>
                </motion.div>
              );
