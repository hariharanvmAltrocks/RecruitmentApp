...
import { CandidateDetails, COIAttach, CommanQuestion, DocumentValue, Icareerportal, QuestionItem, RescheduledCandidate, UpsertDocument, ViewQuestion } from "./ICareerPortal";
import { AdvertisementDetails, CandidateProfile, CheckMyCandidate, COIType, CommentsData, FilterItem, GetAllMaster, GetMasterByCountry, GetProfileByFilter, GetProfileByJobCode, getQuestionById, jobsApplied, PPEDetail, profileDetailAttachments, profileXagent, sendEmail, UpsertMasters, UpsertProfile, UpsertQuestions, WorkflowJson } from "../../models/Icareerportal";
import { EmailService, GetJobRequestData, getProfileData, GetStateByCountryApi, postAdveDetails, PPEMasterTable, QuestionnaireApi, UploadCandidateCVData } from "../AxiosService/CareerPortalAPI";
import { AutoCompleteItem } from "../../models/fieldmodels";
import { ResponeStatus } from "../../utilities/ApiConfig";
import { DocumentLibraray, ListNames, workflowStatusApi } from "../../utilities/Config";
