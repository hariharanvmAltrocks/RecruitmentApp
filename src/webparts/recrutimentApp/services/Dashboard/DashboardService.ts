...
import RoleBasedDashboardService from "./RoleBasedDashboard/RoleBasedDashboard";
...
export default class DashboardService implements IDashboard {
  ...
  private _roleBasedDashboardService = new RoleBasedDashboardService();

  async GetHRLeadDashboard(EmailId: string): Promise<ApiResponse<IHRLeadDashboard>> {
    return this._roleBasedDashboardService.GetHRLeadDashboard(EmailId);
  }

  async GetHRDashboardData(EmailId: string): Promise<ApiResponse<IHRDashboardData>> {
    return this._roleBasedDashboardService.GetHRDashboardData(EmailId);
  }

  async GetLMDashboardData(EmailId: string): Promise<ApiResponse<any>> {
    return this._roleBasedDashboardService.GetLMDashboardData(EmailId);
  }

  async GetHODDashboardData(EmailId: string): Promise<ApiResponse<IHODDashbaord>> {
    return this._roleBasedDashboardService.GetHODDashboardData(EmailId);
  }

  async GetSeniorHRDashboardData(EmailId: string): Promise<ApiResponse<any>> {
    return this._roleBasedDashboardService.GetSeniorHRDashboardData(EmailId);
  }
}