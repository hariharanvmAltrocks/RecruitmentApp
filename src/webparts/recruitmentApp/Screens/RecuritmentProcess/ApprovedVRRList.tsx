...
const RecruitmentProcess = (props: any) => {
  ...
  //   const [CandidateScoreCardDeatails, setCandidateScoreCardDeatails] = React.useState<any[]>([]);
            ...
            : [
                ...
                ...(props.CurrentRoleID === RoleID.HOD
                  ? [
                      ...
                      {
                        label: TabName.ScorecardDetails, // New Tab for Scorecard Details
                        value: "tab2",
                        content: (
                          <Card
                            variant="outlined"
                  ...
                  : [
                      ...(props.CurrentRoleID === RoleID.LineManager
                        ? [
                            {
                              label: TabName.ReviewProfile, // Review Profiles Tab
                              value: "tab1",
                              content: (
                                <Card
                                  variant="outlined"
