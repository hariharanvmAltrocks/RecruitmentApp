      ...
      try {
        ...
        fileReader.onload = async (event: any) => {
          try {
            ...
            try {
              await sp.web
                .getFolderByServerRelativeUrl(positionFolderUrl)
                .get();
            } catch {
              const positionFolderResult =
                await attachmentsLibrary.rootFolder.folders.add(
                  positionFolderName
                );
            ...
            try {
              ...
              console.warn(
                `File ${AttachFile.name} not found. Uploading new file.`
              );
            }
