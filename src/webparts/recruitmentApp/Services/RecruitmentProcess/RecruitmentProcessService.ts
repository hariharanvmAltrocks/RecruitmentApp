    ...
    async GetRecruitmentDetails(filterParam: any, filterConditions: any): Promise<ApiResponse<any | null>> {
        try {
            ...
            for (const item of listItems) {
                ...
                const filter = [{ FilterKey: "RecruitmentID", Operator: "eq", FilterValue: item.ID }];
                let positionresult: any = await this.GetRecrutimentPositionDetails(filter, "");
                ...
                formattedItems.push({ ...Recruitment, ...(positionresult?.data || {}) });
            }
    ...
    async GetRecrutimentPositionDetails(filterParam: any, filterConditions: any) {
        try {
            ...
            const formattedItems = {
                ...
                JobTitleInEnglish: listItems[0].JobTitleEnglish?.JobTitleInEnglish || "",
            ...
            console.log("formattedItems GetRecrutimentPositionDetails", formattedItems);
            return {
                data: formattedItems,
                status: 200,
            ...
            console.error("Error fetching data GetRecrutimentPositionDetails:", error);
            return {
                data: [],
                status: 500,
