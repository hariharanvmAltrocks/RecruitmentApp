          ...
          <div className="ms-Grid-row">
            ...
            <div className="ms-Grid-col ms-lg4">
              <CustomInput
                ...
                error={validationErrors.tab1.Jobcode}
                onChange={(item) =>
                  handleInputChange("tab1", "PositionID", item)
                }
                // disabled={true}
              />
            </div>
            <div className="ms-Grid-col ms-lg4">
              <CustomInput
                ...
                onChange={(item) =>
                  handleInputChange("tab1", "Nationality", item)
                }
                // disabled={true}
              />
            </div>
          ...
          <div className="ms-Grid-row">
            <div className="ms-Grid-col ms-lg4">
              <CustomAutoComplete
                ...
                mandatory={true}
                onChange={(item) =>
                  handleAutoComplete("tab1", "Department", item)
                }
          ...
          <div className="ms-Grid-row">
            <div className="ms-Grid-col ms-lg8">
              <CustomRadioGroup
                ...
                mandatory={true}
                onChange={(item) =>
                  handleRadioChange("tab1", "EmploymentCatagory", item)
                }
              />
            </div>
          </div>
          ...
          <div className="ms-Grid-row">
            <div className="ms-Grid-col ms-lg8">
              <CustomTextArea
                ...
                mandatory={true}
                onChange={(item) =>
                  handleInputChangeTextArea("tab2", "ReasonForVancancy", item)
                }
              />
            </div>
          </div>
          <div className="ms-Grid-row">
            <div className="ms-Grid-col ms-lg4">
              <CustomDatePicker
                ...
                onChange={(date) =>
                  handleDateChange("tab2", "DateRequried", date)
                }
              />
            </div>
            <div className="ms-Grid-col ms-lg4">
              <CustomAutoComplete
                ...
                mandatory={true}
                onChange={(item) =>
                  handleAutoComplete("tab2", "BusinessUnitCode", item)
                }
            ...
            <div className="ms-Grid-col ms-lg4">
              <CustomAutoComplete
                ...
                mandatory={true}
                onChange={(item) =>
                  handleAutoComplete("tab2", "DepartmentCode", item)
                }
        ...
        <Card variant="outlined" sx={{ boxShadow: "0px 2px 4px 3px #d3d3d3" }}>
          <React.Fragment>
            <TabsComponent
              ...
              additionalButtons={[{ label: "Submit" }]}
            />
          </React.Fragment>
        </Card>
      </CustomLoader>
