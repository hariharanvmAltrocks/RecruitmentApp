...
var ShowCandidateDetailsPopup = function (_a) {
    ...
    var _s = (0, Usesubmitcandidatereview_1.useSubmitCandidateReview)(onClose, handleRefresh), submitting = _s.submitting, submit = _s.submit, submitModalState = _s.modalState, submitCloseModal = _s.closeModal;
    ...
    var _z = (0, react_1.useState)(false), open = _z[0], setOpen = _z[1];
    var _0 = (0, react_1.useState)({
        consultedWith: "",
        attachment: [],
        comments: "",
    }), coi = _0[0], setCoi = _0[1];
    var _1 = (0, react_1.useState)({
        panelMembers: [],
        startDate: "",
        endDate: "",
    }), level1 = _1[0], setLevel1 = _1[1];
    var _2 = (0, react_1.useState)({
        panelMembers: [],
        startDate: "",
        endDate: "",
    }), level2 = _2[0], setLevel2 = _2[1];
    var handlePreview = (0, react_1.useCallback)(function (file) {
        ...
        var previewUrl = resolveUrl(rawUrl);
    ...
    var canSubmit = (0, react_1.useMemo)(function () {
        if (ReviewHRFlag) {
            if (!HRReview.trim() && !decisionComments.trim())
                return false;
            if (showCOI) {
                if (!coi.consultedWith.trim() || !coi.comments.trim() || coi.attachment.length === 0)
                    return false;
            }
        }
        if (ReviewLML1) {
                        ...
                        react_1.default.createElement("div", { className: ShowCandidateDetailsPopup_module_scss_1.default.body },
                            react_1.default.createElement("aside", { className: ShowCandidateDetailsPopup_module_scss_1.default.sidebar },
                                ...
                                react_1.default.createElement("div", { className: ShowCandidateDetailsPopup_module_scss_1.default.infoGrid },
                                    ...
                                    react_1.default.createElement("div", { className: ShowCandidateDetailsPopup_module_scss_1.default.infoRow },
                                        react_1.default.createElement("div", { className: ShowCandidateDetailsPopup_module_scss_1.default.infoRowItem },
                                            react_1.default.createElement(reuseUI_1.InfoItem, { icon: react_1.default.createElement(lucide_react_1.AlertTriangle, { size: 14 }), label: "Conflicts", value: (_j = data === null || data === void 0 ? void 0 : data.ConflictsOfInterest) !== null && _j !== void 0 ? _j : "No" })),
                                        react_1.default.createElement("div", { className: ShowCandidateDetailsPopup_module_scss_1.default.infoRowItem },
                                            react_1.default.createElement(reuseUI_1.InfoItem, { icon: react_1.default.createElement(lucide_react_1.Accessibility, { size: 14 }), label: "Disability", value: (_k = data === null || data === void 0 ? void 0 : data.disability) !== null && _k !== void 0 ? _k : "No" }))),
                                    react_1.default.createElement("div", { className: ShowCandidateDetailsPopup_module_scss_1.default.infoRow },
                                        react_1.default.createElement("div", { className: ShowCandidateDetailsPopup_module_scss_1.default.infoRowItem },
                                    ...
                                    react_1.default.createElement(reuseUI_1.InfoItem, { label: "Group / partner companies", value: data === null || data === void 0 ? void 0 : data.hasIvanhoeZijinExperience })),
                            ...
                            react_1.default.createElement("div", { className: ShowCandidateDetailsPopup_module_scss_1.default.mainContent },
                                ...
                                (panelParams === null || panelParams === void 0 ? void 0 : panelParams.statusId) === Config_1.workflowStatusApi.PendingRecruitmentHRscheduleInterview && (react_1.default.createElement(react_1.default.Fragment, null,
                                    react_1.default.createElement(framer_motion_1.motion.section, { className: ShowCandidateDetailsPopup_module_scss_1.default.section, custom: 3, variants: reuseUI_1.sectionVariants, initial: "hidden", animate: "visible" },
                                        ...
                                        react_1.default.createElement(reuseUI_1.InterviewScheduleInput, { form: level1, onChange: setLevel1, panelOptions: ((_o = paneloptions === null || paneloptions === void 0 ? void 0 : paneloptions.Level1) !== null && _o !== void 0 ? _o : []).map(function (item) { return ({
                                ...
                                Number(panelParams === null || panelParams === void 0 ? void 0 : panelParams.statusId) === Config_1.StatusId.PendingwithRecruitmentHRtoassignLevel2InterviewPanel && (react_1.default.createElement(react_1.default.Fragment, null,
                                    react_1.default.createElement(framer_motion_1.motion.section, { className: ShowCandidateDetailsPopup_module_scss_1.default.section, custom: 4, variants: reuseUI_1.sectionVariants, initial: "hidden", animate: "visible" },
                                        ...
                                        react_1.default.createElement(reuseUI_1.InterviewScheduleInput, { form: level2, onChange: setLevel2, panelOptions: ((_p = paneloptions === null || paneloptions === void 0 ? void 0 : paneloptions.Level2) !== null && _p !== void 0 ? _p : []).map(function (item) { return ({
                                                value: String(item.value),
                                                label: item.label,
