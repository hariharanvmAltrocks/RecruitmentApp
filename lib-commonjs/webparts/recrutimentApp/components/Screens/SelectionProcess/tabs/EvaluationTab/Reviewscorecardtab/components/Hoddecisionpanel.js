    ...
    if (!canEdit) {
        return (React.createElement("div", { className: Reviewscorecardtab_module_scss_1.default.mDecisionCard, style: { borderColor: "#e2e8f0", background: "#f8fafc" } },
            ...
            React.createElement("div", { className: Reviewscorecardtab_module_scss_1.default.mFormGroup },
                React.createElement("button", { onClick: onViewComments, className: Reviewscorecardtab_module_scss_1.default.mActionBtn },
    ...
    return (React.createElement("div", { className: Reviewscorecardtab_module_scss_1.default.mDecisionCard },
        React.createElement("div", { className: Reviewscorecardtab_module_scss_1.default.mDecisionHeader },
            ...
            React.createElement("div", null,
                ...
                React.createElement("div", { className: Reviewscorecardtab_module_scss_1.default.mDecisionSub }, "As HOD, review the evaluation and provide your decision."))),
        React.createElement("div", { className: Reviewscorecardtab_module_scss_1.default.mDecisionGrid }, [
            { val: "Yes", cls: Reviewscorecardtab_module_scss_1.default.mDCardYes, Icon: lucide_react_1.CheckCircle2, label: "YES, SELECT" },
            { val: "No", cls: Reviewscorecardtab_module_scss_1.default.mDCardNo, Icon: lucide_react_1.X, label: "NO, REJECT" },
            { val: "On Hold", cls: Reviewscorecardtab_module_scss_1.default.mDCardHold, Icon: lucide_react_1.Activity, label: "ON HOLD" },
        ].map(function (_a) {
            var val = _a.val, cls = _a.cls, Icon = _a.Icon, label = _a.label;
            return (React.createElement("button", { key: val, className: "".concat(Reviewscorecardtab_module_scss_1.default.mDCard, " ").concat(hodDecision === val ? cls : "", " ").concat(errors.decision ? Reviewscorecardtab_module_scss_1.default.mInputErr : ""), onClick: function () { onDecisionChange(val); } },
        ...
        React.createElement("div", { className: Reviewscorecardtab_module_scss_1.default.mFormGroup },
            React.createElement("button", { onClick: onViewComments, className: Reviewscorecardtab_module_scss_1.default.mActionBtn },
                React.createElement(lucide_react_1.FileText, { size: 16 }),
                " VIEW COMMENTS")),
        shouldShowPositionId(statusId, hodDecision) && (React.createElement("div", { className: Reviewscorecardtab_module_scss_1.default.mFormGroup },
            React.createElement("label", { className: "".concat(Reviewscorecardtab_module_scss_1.default.mFormLabel, " ").concat(errors.position ? Reviewscorecardtab_module_scss_1.default.mErrLabel : "") },
                "Assign Position ID ",
                React.createElement("span", { style: { color: "#ef4444" } }, "*"),
                errors.position && React.createElement("span", { className: Reviewscorecardtab_module_scss_1.default.mErrText }, " \u2014 Required")),
            React.createElement("select", { className: "".concat(Reviewscorecardtab_module_scss_1.default.mSelect, " ").concat(errors.position ? Reviewscorecardtab_module_scss_1.default.mInputErr : ""), value: selectedPositionId !== null && selectedPositionId !== void 0 ? selectedPositionId : "", onChange: function (e) {
        ...
        React.createElement("div", { className: Reviewscorecardtab_module_scss_1.default.mFormGroup },
            React.createElement("label", { className: "".concat(Reviewscorecardtab_module_scss_1.default.mFormLabel, " ").concat(errors.comment ? Reviewscorecardtab_module_scss_1.default.mErrLabel : "") },
                feedbackLabel,
                " ",
                React.createElement("span", { style: { color: "#ef4444" } }, "*"),
                errors.comment && React.createElement("span", { className: Reviewscorecardtab_module_scss_1.default.mErrText }, " \u2014 Required")),
            React.createElement("textarea", { className: "".concat(Reviewscorecardtab_module_scss_1.default.mTextarea, " ").concat(errors.comment ? Reviewscorecardtab_module_scss_1.default.mInputErr : ""), placeholder: "Provide your final decision rationale...", value: decisionComment, onChange: function (e) { return onCommentChange(e.target.value); } })),
        React.createElement("div", { className: Reviewscorecardtab_module_scss_1.default.mFormGroup },
        ...
        React.createElement("div", { className: Reviewscorecardtab_module_scss_1.default.mFooter },
            ...
            React.createElement("button", { className: Reviewscorecardtab_module_scss_1.default.mSubmitBtn, onClick: onSubmit, disabled: submitting || !hodDecision }, submitting ? "Submitting…" : React.createElement(React.Fragment, null,
