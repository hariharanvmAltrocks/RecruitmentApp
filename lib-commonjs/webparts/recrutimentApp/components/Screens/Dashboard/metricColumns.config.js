...
var resolvedGradientStart = "var(--app-primary-color)";
var resolvedGradientEnd = "var(--app-secondary-color)";
var BASE_METRICS = (_a = {},
    _a[ConditionConfig_1.MatricID.AssignHr] = {
        ...
        iconType: "hr",
        path: "/MyTracker",
        menuId: ConditionConfig_1.menuID.Mytracker,
        TabValue: "tab1",
    ...
    _a[ConditionConfig_1.MatricID.MySubmission] = {
    ...
    _a[ConditionConfig_1.MatricID.MySubmissionHR] = {
        label: "My Submission",
        status: "ON-GOING",
        icon: lucide_react_1.Building2,
        color: resolvedGradientEnd,
    ...
    _a[ConditionConfig_1.MatricID.MySubmissionLM] = {
        label: "My Submission",
        status: "ON-GOING",
        icon: lucide_react_1.Building2,
        color: resolvedGradientEnd,
...
var MatricColums = function (roles) {
    ...
    if (roles.includes(Config_1.RoleID.LineManager) && roles.includes(Config_1.RoleID.HOD)) {
        roleColumns = [
            ...
            buildCol(ConditionConfig_1.MatricID.MySubmissionLM, { showArrow: false }),
        ];
            ...
            switch (role) {
                case Config_1.RoleID.RecruitmentHRLead:
                    roleColumns = [
                        ...
                        buildCol(ConditionConfig_1.MatricID.OfferRejected, { showArrow: false }),
                        buildCol(ConditionConfig_1.MatricID.Onbording, { showArrow: false }),
                        buildCol(ConditionConfig_1.MatricID.MySubmission, { showArrow: false }),
                    ];
                    break;
                ...
                case Config_1.RoleID.HOD:
                    roleColumns = [
                        ...
                        buildCol(ConditionConfig_1.MatricID.OfferRejected, { showArrow: false }),
                        buildCol(ConditionConfig_1.MatricID.Onbording, { showArrow: false }),
                        buildCol(ConditionConfig_1.MatricID.MySubmissionHOD, { showArrow: false }),
                    ];
                    break;
...
var MetricQueryConfig = function (EmailId, roles) {
    ...
    return (_a = {},
        ...
        _a[ConditionConfig_1.MatricID.AssignHr] = [
            ...
            createQuery(Config_1.ListNames.HRMSAdditionalHeadCountForExisitingPosition, tslib_1.__spreadArray(tslib_1.__spreadArray([], StatusFilter({ status: Config_1.StatusId.ReadyforRecruitmentProcess }), true), DataSyncFilter, true), ["Id"]),
        ...
        // ✅ Evaluation LM
        _a[ConditionConfig_1.MatricID.EvalutionLM] = createQuery(Config_1.ListNames.HRMSRecruitmentCandidatePersonalDetails, StatusFilter({ status: Config_1.StatusId.InterviewLevel1InProgress })),
        // ✅ Evaluation HOD
        ...
        // ✅ Evaluation EXCO
        _a[ConditionConfig_1.MatricID.EvalutionEXCO] = createQuery(Config_1.ListNames.HRMSRecruitmentCandidatePersonalDetails, StatusFilter({ status: Config_1.StatusId.InterviewLevel2InProgress })),
        // ✅ Offer Release
