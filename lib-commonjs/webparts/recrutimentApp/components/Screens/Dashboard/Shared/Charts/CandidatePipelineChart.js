    ...
    return (react_1.default.createElement(Card_1.default, { className: CandidatePipelineChart_module_scss_1.default.container },
        ...
        react_1.default.createElement("div", { className: CandidatePipelineChart_module_scss_1.default.tableWrapper },
            react_1.default.createElement("table", { className: CandidatePipelineChart_module_scss_1.default.table },
                ...
                react_1.default.createElement("tbody", null, displayedData.map(function (stage, index) { return (react_1.default.createElement("tr", { key: index },
                    ...
                    react_1.default.createElement("td", { className: CandidatePipelineChart_module_scss_1.default.tdPercent },
                        stage.percentage,
                        "%"))); })))),
        totalPages > 1 && (react_1.default.createElement("div", { className: CandidatePipelineChart_module_scss_1.default.pagination },
            react_1.default.createElement("button", { type: "button", className: CandidatePipelineChart_module_scss_1.default.pageArrow, onClick: function () { return setCurrentPage(function (prev) { return Math.max(1, prev - 1); }); }, disabled: safeCurrentPage === 1, "aria-label": "Previous Page" }, "\u2039"),
            pages.map(function (p) { return (react_1.default.createElement("button", { key: p, type: "button", className: "".concat(CandidatePipelineChart_module_scss_1.default.pageNumber, " ").concat(p === safeCurrentPage ? CandidatePipelineChart_module_scss_1.default.active : ""), onClick: function () { return setCurrentPage(p); } }, p)); }),
            react_1.default.createElement("button", { type: "button", className: CandidatePipelineChart_module_scss_1.default.pageArrow, onClick: function () { return setCurrentPage(function (prev) { return Math.min(totalPages, prev + 1); }); }, disabled: safeCurrentPage === totalPages, "aria-label": "Next Page" }, "\u203A")))));
};
