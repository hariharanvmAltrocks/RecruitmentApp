...
var ContractService = /** @class */ (function () {
    ...
    ContractService.getContracts = function () {
    ...
    ContractService.getContractsByHr = function (hrName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var all;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getContracts()];
                    case 1:
                        all = _a.sent();
                        return [2 /*return*/, all.filter(function (c) { return c.assignedHR.toLowerCase() === hrName.toLowerCase(); })];
                }
            });
        });
    };
    ContractService.getHRWorkflows = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        setTimeout(function () {
