...
var useDashboardMetrics = function (roleIDs, EmailID, refreshKey) {
    ...
    var queries = (0, react_1.useMemo)(function () {
        return (0, metricColumns_config_1.getRoleBasedFilters)(roleIDs, EmailID);
    }, [roleIDs, EmailID]);
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, ServiceExport_1.DashboardServices.GetDashboardCount(queries, roleIDs, EmailID)];
                case 1:
                    data = _a.sent();
