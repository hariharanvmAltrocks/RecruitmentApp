...
var useSeniorHRDashboard = function () {
    ...
    var fetchSeniorHRDashboardData = (0, react_1.useCallback)(function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var email, res, err_1;
        var _a;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ServiceExport_1.DashboardServices.GetSeniorHRDashboardData(email)];
                case 1:
                    res = _b.sent();
                ...
                case 2:
                    err_1 = _b.sent();
                    console.error("Senior HR Dashboard fetch error:", err_1);
...
exports.useSeniorHRDashboard = useSeniorHRDashboard;
exports.default = exports.useSeniorHRDashboard;
//# sourceMappingURL=useSeniorHRDashboard.js.map