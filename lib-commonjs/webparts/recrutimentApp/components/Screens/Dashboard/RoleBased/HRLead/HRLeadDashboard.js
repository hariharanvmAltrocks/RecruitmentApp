...
var HRLeadDashboard = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: Dashboard_module_scss_1.default.dashboardContainer },
        ...
        react_1.default.createElement("div", { className: Dashboard_module_scss_1.default.kpiGrid },
            react_1.default.createElement(KPICard_1.default, { title: "Total Positions", value: "74%", iconName: "TrendingUp", iconTheme: "blue", footerText: "View HR breakdown" }),
            react_1.default.createElement(KPICard_1.default, { title: "Active Positions", value: (kpis === null || kpis === void 0 ? void 0 : kpis.assignedContracts) || 92, iconName: "FileText", iconTheme: "purple", footerText: "View assignments" }),
            react_1.default.createElement(KPICard_1.default, { title: "Due This Month", value: "25 / 92", iconName: "CheckCircle2", iconTheme: "green", footerText: "View SLA status" }),
            react_1.default.createElement(KPICard_1.default, { title: "Overdue Positions", value: (kpis === null || kpis === void 0 ? void 0 : kpis.overdueContracts) || 8, iconName: "AlertCircle", iconTheme: "red", footerText: "View escalations" }),
            react_1.default.createElement(KPICard_1.default, { title: "Complete Position", value: (kpis === null || kpis === void 0 ? void 0 : kpis.candidates) || 184, iconName: "Users", iconTheme: "gray", footerText: "View candidate tracker" }),
            react_1.default.createElement(KPICard_1.default, { title: "Total Recrutiment HR", value: (kpis === null || kpis === void 0 ? void 0 : kpis.candidates) || 184, iconName: "Users", iconTheme: "gray", footerText: "View candidate tracker" })),
