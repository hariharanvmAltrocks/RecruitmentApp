        ...
        react_1.default.createElement("div", { className: "iq-composer__body" },
            react_1.default.createElement("div", { className: "iq-composer__col" },
                ...
                react_1.default.createElement("div", { className: "iq-composer__field" },
                    react_1.default.createElement("label", { className: "iq-composer__label iq-composer__label--en" },
                        ...
                        " Question Prompt"),
                    react_1.default.createElement("textarea", { className: "iq-composer__textarea", placeholder: "Enter the question in English...", value: (_b = newQuestion.questionEn) !== null && _b !== void 0 ? _b : "", onChange: function (e) { return onChange(tslib_1.__assign(tslib_1.__assign({}, newQuestion), { questionEn: e.target.value })); } })),
                react_1.default.createElement("div", { className: "iq-composer__field" },
                    react_1.default.createElement("label", { className: "iq-composer__label iq-composer__label--en" },
                        react_1.default.createElement(lucide_react_1.CheckCircle2, { size: 11 }),
                        " Expected Answer"),
                    react_1.default.createElement("textarea", { className: "iq-composer__textarea", placeholder: "What are the key points for a good answer?", value: (_c = newQuestion.answerEn) !== null && _c !== void 0 ? _c : "", onChange: function (e) { return onChange(tslib_1.__assign(tslib_1.__assign({}, newQuestion), { answerEn: e.target.value })); } }))),
            react_1.default.createElement("div", { className: "iq-composer__col iq-composer__col--fr" },
                ...
                react_1.default.createElement("div", { className: "iq-composer__field" },
                    ...
                    react_1.default.createElement("textarea", { className: "iq-composer__textarea iq-composer__textarea--italic", placeholder: "Saisissez la question en fran\u00E7ais...", value: (_d = newQuestion.questionFr) !== null && _d !== void 0 ? _d : "", onChange: function (e) { return onChange(tslib_1.__assign(tslib_1.__assign({}, newQuestion), { questionFr: e.target.value })); } })),
                react_1.default.createElement("div", { className: "iq-composer__field" },
                    react_1.default.createElement("label", { className: "iq-composer__label iq-composer__label--fr" },
                        react_1.default.createElement(lucide_react_1.CheckCircle2, { size: 11 }),
                        " R\u00E9ponse Attendue"),
                    react_1.default.createElement("textarea", { className: "iq-composer__textarea iq-composer__textarea--italic", placeholder: "Quels sont les points cl\u00E9s d'une bonne r\u00E9ponse ?", value: (_e = newQuestion.answerFr) !== null && _e !== void 0 ? _e : "", onChange: function (e) { return onChange(tslib_1.__assign(tslib_1.__assign({}, newQuestion), { answerFr: e.target.value })); } }))))));
};
