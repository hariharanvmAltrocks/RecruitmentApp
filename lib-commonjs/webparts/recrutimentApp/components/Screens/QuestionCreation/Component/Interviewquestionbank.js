    ...
    return (react_1.default.createElement("div", { className: "iq-bank" },
        react_1.default.createElement("div", { className: "iq-bank__header" },
            ...
            react_1.default.createElement("div", null,
                react_1.default.createElement("h3", { className: "iq-bank__title" }, strings.QuestionBank),
                react_1.default.createElement("p", { className: "iq-bank__subtitle" }, strings.ReuseStandardQuestions))),
        react_1.default.createElement("div", { className: "iq-bank__list" }, loading ? (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement("p", { className: "iq-bank__empty-text" }, strings.NoTemplatesAvailable))) : (react_1.default.createElement(framer_motion_1.AnimatePresence, null, questionBank.map(function (q, i) {
            var isAdded = preparedQuestionIds.includes(q.id);
            return (react_1.default.createElement(framer_motion_1.motion.div, { key: q.id, className: "iq-bank__card ".concat(isAdded ? "iq-bank__card--added" : ""), initial: { opacity: 0, y: 12 }, animate: { opacity: 1, y: 0 }, transition: {
                    delay: i * 0.04,
                    duration: 0.28,
                    ease: "easeOut",
                }, 
                ...
                react_1.default.createElement("div", { className: "iq-bank__card-top" },
                    react_1.default.createElement("span", { className: "iq-bank__template-label" },
                        i + 1,
                        strings.NbspNbspStandardTemplate),
                    react_1.default.createElement("button", { className: "iq-bank__add-btn ".concat(isAdded ? "iq-bank__add-btn--added" : ""), onClick: function () { return !isAdded && onAddFromBank(q); }, title: isAdded ? strings.AlreadyAdded : strings.AddToInterviewSet1 }, isAdded ? (react_1.default.createElement(lucide_react_1.CheckCircle2, { size: 15 })) : (react_1.default.createElement(lucide_react_1.Plus, { size: 15 })))),
                react_1.default.createElement("div", { className: "iq-bank__card-body" },
                    react_1.default.createElement("div", { className: "iq-bank__lang-row" },
                        react_1.default.createElement("span", { className: "iq-bank__lang-pill iq-bank__lang-pill--en" }, strings.En),
                        react_1.default.createElement("p", { className: "iq-bank__question-text" }, q.questionEn)),
                    react_1.default.createElement("div", { className: "iq-bank__lang-row" },
                        react_1.default.createElement("span", { className: "iq-bank__lang-pill iq-bank__lang-pill--fr" }, strings.Fr),
