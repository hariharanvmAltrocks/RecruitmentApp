...
function getEvaluationFormData(candidateId, currentUserEmail) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var _a, candidateRows, currentUserGuid_1, raw, recruitmentId, jobCodeId, jobCodeStr, fullName, interviewDateRaw, interviewDate, _b, panelRows, reviewerRes, currentUserPanel, uniqueEmails, emailToName_1, panelMembers, reviewer, reviewerName, jobTitleEn, jobTitleFr, grade, questions, _c, gradeRes, questionsResult, result, error_1;
        var _this = this;
        ...
        return tslib_1.__generator(this, function (_4) {
            switch (_4.label) {
                case 0:
                    console.log('[EvaluationFormService] getEvaluationFormData start', { candidateId: candidateId, currentUserEmail: currentUserEmail });
                    _4.label = 1;
                case 1:
                    _4.trys.push([1, 6, , 7]);
                ...
                case 5:
                    ...
                    console.log('[EvaluationFormService] getEvaluationFormData result', result);
                    return [2 /*return*/, result];
                case 6:
                    error_1 = _4.sent();
                    console.error('[EvaluationFormService] getEvaluationFormData error', error_1);
        ...
        return tslib_1.__generator(this, function (_p) {
            switch (_p.label) {
                ...
                case 1:
                    ...
                    console.log('[EvaluationFormService] submitScorecard inserted', { newId: newId, params: params });
