...
var EMPTY = function (candidateId) { return ({
    ...
    applicantName: '', nationality: '', nationalityCode: '',
            ...
            switch (_11.label) {
                ...
                case 3:
                    ...
                    if (!currentUserPanel && currentUserEmail) {
                        currentUserPanel = panelRows.find(function (p) { var _a; return (((_a = p.InterviewPanel) === null || _a === void 0 ? void 0 : _a.EMail) || '').toLowerCase() === currentUserEmail.toLowerCase(); });
                    ...
                    console.log('[getEvaluationFormData] FINAL currentUserPanel:', currentUserPanel
                        ? { ID: currentUserPanel.ID, Level: currentUserPanel.InterviewLevel, Email: (_s = currentUserPanel.InterviewPanel) === null || _s === void 0 ? void 0 : _s.EMail }
        ...
        return tslib_1.__generator(this, function (_p) {
            switch (_p.label) {
                ...
                case 14:
                    ...
                    return [2 /*return*/, { success: false, message: 'An error occurred while submitting. Please try again.' }];
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (!userPanel && currentUserEmail) {
                        userPanel = rows.find(function (p) { var _a; return (((_a = p.InterviewPanel) === null || _a === void 0 ? void 0 : _a.EMail) || '').toLowerCase() === currentUserEmail.toLowerCase(); });
                    }
                    if (!userPanel) {
