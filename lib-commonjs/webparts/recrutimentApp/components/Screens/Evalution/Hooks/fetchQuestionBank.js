...
var defaultService = {
    getQuestions: function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, wait(300)];
                case 1:
                    _a.sent();
                    return [2 /*return*/, mockQuestions];
            }
        });
    }); }
};
function useQuestionBank(service) {
    var _this = this;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, service.getQuestions()];
                    case 2:
                        result = _a.sent();
                        if (isMounted) {
                            setData(result);
