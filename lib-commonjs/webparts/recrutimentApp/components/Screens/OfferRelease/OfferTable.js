...
function resolveActionMode(statusID) {
    if (REVIEW_STATUSES.has(statusID))
        return "Review";
    if (EDIT_STATUSES.has(statusID))
        return "Edit";
...
var ActionCell = react_1.default.memo(function (_a) {
    ...
    var isUpload = actionMode === "Upload";
    var isReview = actionMode === "Review";
    var ActionIcon = isUpload ? lucide_react_1.Upload : lucide_react_1.Eye;
    var actionLabel = isUpload ? "Upload" : isReview ? "Review" : "View";
...
function buildColumns(actionMode, onAction) {
    return [
        {
            id: "PositionID",
            header: "Position ID",
        ...
        },
        {
            ...
            render: function (item) { return (react_1.default.createElement(ActionCell, { item: item, actionMode: actionMode, onAction: onAction })); },
        },
    ];
}
// ─── Component ────────────────────────────────────────────────────────────────
var OfferTable = function () {
    ...
    var _t = (0, useStateFromManage_1.useStateOfferRelease)(), drawerOpen = _t.drawerOpen, selectedJobId = _t.selectedJobId, CandidateID = _t.CandidateID, selectedcandidateID = _t.selectedcandidateID, jobrequestID = _t.jobrequestID, reviewerComments = _t.reviewerComments, acknowledgementCheckbox = _t.acknowledgementCheckbox, loadingState = _t.loadingState, openDrawer = _t.openDrawer, closeDrawer = _t.closeDrawer, setComments = _t.setComments, toggleAcknowledgement = _t.toggleAcknowledgement, setLoadingState = _t.setLoadingState, setSelectedJobId = _t.setSelectedJobId, setSelectedcandidateID = _t.setSelectedcandidateID, setJobrequestID = _t.setJobrequestID, setCandidateID = _t.setCandidateID;
    // ── Derived values ─────────────────────────────────────────────────────────
    var actionMode = (0, react_1.useMemo)(function () { return resolveActionMode(matricID); }, [matricID]);
    ...
    var columns = (0, react_1.useMemo)(function () { return buildColumns(actionMode, handleAction); }, [actionMode, handleAction]);
