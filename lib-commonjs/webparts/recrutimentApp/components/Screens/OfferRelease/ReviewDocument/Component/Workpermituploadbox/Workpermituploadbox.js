...
var UploadPlaceholder = function () { return (react_1.default.createElement("div", { className: "upload-box__placeholder" },
    ...
    react_1.default.createElement("div", { className: "upload-box__text" },
        react_1.default.createElement("span", { className: "upload-box__primary" }, "Click to upload Work Permit Acknowledgement"),
        react_1.default.createElement("span", { className: "upload-box__secondary" }, "PDF or Word document \u00B7 max 5 MB")))); };
    ...
    return (react_1.default.createElement("div", { className: "upload-workpermit-card" },
        react_1.default.createElement("div", { className: "upload-workpermit-card__header" },
            ...
            react_1.default.createElement("div", { className: "upload-workpermit-card__header-text" },
                react_1.default.createElement("p", { className: "upload-workpermit-card__title" }, "Work Permit Acknowledgement"),
                react_1.default.createElement("p", { className: "upload-workpermit-card__subtitle" }, "Upload the signed acknowledgement document"))),
        ...
        hasFileError && (react_1.default.createElement("span", { className: "upload-box__error-text" }, "Please upload the Work Permit Acknowledgement document."))));
};
