...
var useMasterData = function () {
    ...
    var fetchAllData = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        // miningExpRes,
        qualRes, techSkillsRes, roleKnowledgeRes, 
        // managersRes,
        levelres, functionalType_1, processResult, list, mappedMgrs, mergedMgrs, list, mappedMgrs, mergedMgrs, err_1;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _a = _b.sent(), totalExpRes = _a[0], qualRes = _a[1], techSkillsRes = _a[2], roleKnowledgeRes = _a[3], levelres = _a[4], functionalType_1 = _a[5];
    ...
    // }, []);
    (0, react_1.useEffect)(function () {
        var fetchJobTitles = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var jobTitleres, mappedTitles, error_1;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, ServiceExport_1.CommonServices.GetMasterData(Config_1.ListNames.HRMSJobTitleMaster)];
                    case 1:
                        jobTitleres = _a.sent();
                        if ((jobTitleres === null || jobTitleres === void 0 ? void 0 : jobTitleres.status) === 200 &&
                            Array.isArray(jobTitleres.data)) {
                            mappedTitles = jobTitleres.data.map(function (item) { return ({
                                id: item.ID,
                                value: String(item.ID),
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.error("Job Title Load Error", error_1);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
