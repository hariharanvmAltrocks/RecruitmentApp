            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(MatricID === 1)) return [3 /*break*/, 2];
                        return [4 /*yield*/, ServiceExport_1.RecruitmentServices.GetNPAEPVRRDetails(IDFilter, condition, type)];
                    case 1:
                        response = _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, ServiceExport_1.RecruitmentServices.GetRecruitmentDetails(IDFilter, condition)];
                    case 3:
                        response = _a.sent();
                        _a.label = 4;
                    case 4:
