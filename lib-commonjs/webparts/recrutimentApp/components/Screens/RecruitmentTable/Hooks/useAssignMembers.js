...
var useAssignMembers = function (Nationality) {
    ...
    var isRecruitmentHR = roleIDs.includes(Config_1.RoleID.RecruitmentHR);
    ...
    (0, react_1.useEffect)(function () {
        if (isRecruitmentHR)
            return;
        var isMounted = true;
        var loadHRMembers = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (status_1 === 200 && data && isMounted) {
