        ...
        react_1.default.createElement("div", { className: "metric-card__icon-wrap" },
            react_1.default.createElement(framer_motion_1.motion.div, { className: "metric-card__icon", style: {
                    background: active
                        ...
                        : ((_b = metric.bgColor) !== null && _b !== void 0 ? _b : "#f3f4f6"),
                    boxShadow: active ? "inset 0 0 0 1px rgba(255,255,255,0.4)" : "none"
                } },
                react_1.default.createElement(metric.icon, { size: 20, strokeWidth: 2.5, style: { color: active ? "#fff" : ((_c = metric.color) !== null && _c !== void 0 ? _c : "#6b7280") } }))),
